...
interface StateProps {
  ...
  updateFullName: (firstName: string, lastName: string) => void;
}
    ...
    <RightFloatingDialog
      ...
      <Formik
        ...
        onSubmit={(formValues: FormValues, { setSubmitting }: FormikHelpers<FormValues>) => {
          props.updateFullName(formValues.firstName, formValues.lastName);
          setSubmitting(false);
          props.closeDialog();
        }}>
        {({ errors, isSubmitting }) => (
...
const mapDispatchToProps = (dispatch: Function) => ({
  updateFullName: (firstName: string, lastName: string) => {
    dispatch(accountProfileAction.updateFullName(firstName, lastName));
  },
});

export default connect(null, mapDispatchToProps)(UpdateNameDialog);
